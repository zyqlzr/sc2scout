...
LnLstmPolicy, MlpPolicy, MixPolicyV1, MixPolicy
...
flags.DEFINE_string("difficulty", "A", "Bot difficulty (from '1' to 'A')")
...
def main(unused_argv):
    ...
    env = make(FLAGS.wrapper, env)
    agent = ppo2.load_model(MixPolicyV1, env,model_dir)
